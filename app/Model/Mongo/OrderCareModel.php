...
class OrderCareModel extends EloquentModel
{
    protected $connection = 'mongodb';
    protected $collection = 'az_order_care';
    ...
    {
        return $this->hasOne(OrderShipModel::class, 'order_id', '_id')->orderBy('_id', 'DESC');
    }
    ...
    {
        return $this->hasMany(OrderActivityModel::class, 'order_id', '_id')->orderBy('_id', 'DESC');
    }
