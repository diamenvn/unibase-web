              ...
              <table id="headerTable" class="table-filter w-100">
                <thead>
                  <tr class="text-center merge">
                    ...
                    <th colspan="2">Nhân sự phụ trách</th>
                  ...
                  <tr class="sub-header">
                    ...
                    <th data-index="3" class="th-typeview-ngay_lead_chuyen_sale">
                      <div class="th-container" style="top: 0px; border-bottom: 0px;"><span class="vg-label fix_width" style="">Ngày nhận đơn</span></div>
                    </th>
                    <th data-index="4" class="th-typeview-sale">
                      <div class="th-container" style="top: 0px; border-bottom: 0px;"><span class="vg-label fix_width" style="">Nhân sự sale</span></div>
                    </th>
                    <th data-index="4" class="th-typeview-sale">
                      <div class="th-container" style="top: 0px; border-bottom: 0px;"><span class="vg-label fix_width" style="">Nhân sự chăm sóc</span></div>
                    </th>
...
<script>
  const api = {
    getOrderList: function(callback) {
      lib.send.get('{{route("api.order.lists.care")}}', callback, window.location.search);
    }
  }
  ...
  const html = {
    renderList: function(res, item) {
      userReciver = userCare = userCreated = filterStatus = '';
      if (item.reciver) {
      ...
      if (item.care) {
        userCare = '<span style="background: #0084D1" class="d-inline-block mb-1 user--reciver mr-2">' + item.care.name + '<i class="fas fa-star ml-1 fs-12 text-warning"></i></span>';
      }
    ...
    emptyData: function() {
      return '<td class="text-center p-3 bold fs-18" colspan="14">Không có dữ liệu khách hàng nào</td>';
    }
  }
  $(function() {
